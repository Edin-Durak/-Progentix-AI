...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function startVideoTimer() {
    ...
    videoTimer = setInterval(() => {
      ...
      console.log(`Video play time: ${videoPlayTime / 1000} seconds`);

      // Check if 2 minutes of video playback reached
      if (videoPlayTime >= VIDEO_DELAY_TIME) {
        console.log("2 minutes of video playback reached - loading content");
        loadDelayedContent();
        stopVideoTimer();
      }
    }, 1000);
